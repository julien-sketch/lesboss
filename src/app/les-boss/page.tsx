    ...
    <main>
      <section className="boss-grid px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="text-balance text-5xl font-black uppercase leading-tight text-ink sm:text-7xl">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            {pillars.map((pillar, index) => {
              ...
              <div
                key={pillar.text}
                className={`rounded-boss bg-white p-8 shadow-boss transition duration-300 ${
      ...
      <section className="bg-ink px-4 py-20 text-white sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h2 className="mt-4 text-balance text-4xl font-black sm:text-6xl">
